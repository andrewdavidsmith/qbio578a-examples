 ...
 * memory. I tried to use old-school C (c89) in this example so
 * students would get a sense of what different "eras" of C code might
 * look like.
 *
...
int main(const int argc, char *const argv[]) {
  ...
  capacity = 1; /* start with at least some space to store matches --
                   you can't double the capacity of it starts at
                   0... */
